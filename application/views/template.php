	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?= base_url(); ?>Kota" class="active"><i class="lnr lnr-home"></i> <span>Kota</span></a></li>
						<li><a href="<?= base_url(); ?>Destinasi" class=""><i class="lnr lnr-code"></i> <span>Destinasi</span></a></li>
						<li><a href="<?= base_url(); ?>Paket" class=""><i class="lnr lnr-code"></i> <span>Paket</span></a></li>
						<li><a href="<?= base_url(); ?>Tourguide" class=""><i class="lnr lnr-code"></i> <span>Tourguide</span></a></li>
						<li><a href="<?= base_url(); ?>User" class=""><i class="lnr lnr-chart-bars"></i> <span>User</span></a></li>
						<li><a href="panels.html" class=""><i class="lnr lnr-cog"></i> <span>Pemesanan</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
